...
import Business.TrainerUserAccounts.TrainerUserAccount;import java.awt.CardLayout;
 ...
 * @author dell
 */
public class CrossFitTrainerUserAccounts extends javax.swing.JPanel {

    /**
     * Creates new form CrossFitTrainerUserAccounts
     */
   JPanel userProcessContainer;
   Organization organization;
  EcoSystem system;
       public   CrossFitTrainerUserAccounts(JPanel userProcessContainer, Organization organization,EcoSystem system) {
       initComponents();
       ...
       public void popData()
       {
           ...
           model.setRowCount(0);
            for (Trainers trainers : organization.getTrainerDirectory().getTrainerDirectory()) {
            for (TrainerUserAccount ua : organization.getUserAccountsDirectory().getUserAccountList()) {
