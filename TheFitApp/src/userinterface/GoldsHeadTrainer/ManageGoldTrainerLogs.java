 ...
 * @author dell
 */
public class ManageGoldTrainerLogs extends javax.swing.JPanel {

    /**
     * Creates new form ManageTrainerLogs
     */
    JPanel userProcessContainer;
    EcoSystem system;
    Organization organization;
    public ManageGoldTrainerLogs(JPanel userProcessContainer, EcoSystem system, Organization organization) {
        initComponents();
    ...
    private void initComponents() {
        ...
        add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 200, 320, 130));
